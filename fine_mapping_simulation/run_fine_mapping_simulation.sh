...
##########################
# 3. Run ca-QTL mediated eQTL fine-mapping
##########################
ca_qtl_mediated_eqtl_finemapping_output_file="${simulation_fine_mapping_results_dir}${simulation_stem}_ca_qtl_mediated_eqtl_finemapping_results.txt"
ca_qtl_mediated_eqtl_finemapping_hyperparameter_file="${simulation_fine_mapping_results_dir}${simulation_stem}_ca_qtl_mediated_eqtl_finemapping_shared_hyperparameters.txt"

python run_ca_qtl_mediated_eqtl_finemapping.py \
    --sumstat_summary_file ${sim_sumstat_summary_file} \
    --fine_mapping_output_file ${ca_qtl_mediated_eqtl_finemapping_output_file} \
    --eqtl_sample_size ${eqtl_sample_size} \
    --shared_hyperparameter_output_file ${ca_qtl_mediated_eqtl_finemapping_hyperparameter_file}
